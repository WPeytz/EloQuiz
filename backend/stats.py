...
def get_students():
    ...
    students_ref = firestore.client().collection('users').where('teacherCode', '==', class_code)
    ...
    for student in students:
        ...
        user_id = student.id
        user_ref = firestore.client().collection('answers').where('user_id', '==', user_id)
...
def remove_student():
    ...
    try:
        ...
        answers = firestore.client().collection('answers').where('user_id', '==', user_id).stream()
